...
parser.add_argument('--disable-start-on-logon',action="store_true",dest='disableStartOnLogon',default=False,help="When installing, disable NVDA's start at the logon screen")
