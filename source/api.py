...
def setReviewPosition(reviewPosition,clearNavigatorObject=True,isCaret=False,isMouse=False):
	...
	if isCaret:
		visionCointext = vision.CONTEXT_CARET
	elif isMouse:
		visionCointext = vision.CONTEXT_MOUSE
	else:
		visionCointext = vision.CONTEXT_REVIEW
	vision.handler.handleReviewMove(context=visionCointext)
